                            ...
                            <div class="manage-menus">
                                <form method="get" action="{{ $currentUrl }}">
                                    ...
                                    <span class="submit-btn">
                                        <input style="width: 120px; height: 38px; border-radius: 4px;" type="submit"
                                            class="button-secondary" value="Choose">
                                    </span>
